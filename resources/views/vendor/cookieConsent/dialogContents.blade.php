    ...
    <div class="row ">
        <div class="col-md-4 col-sm-12 button-fixed">
            <div class="p-3 pb-4 bg-custom text-white">
                ...
                <button type="button"
                        class="m-1 btn btn-primary w-100 js-cookie-consent-agree cookie-consent__agree">{{ trans('cookieConsent::texts.agree') }}</button>
                <p style="font-size: 10px;" class="text-light ml-1">
